...
export default function Header() {
  ...
  return (
    <motion.nav
      className="fixed justify-self-center max-w-7xl w-[90%] sm:w-[92%] md:w-5/6 top-0 mx-auto mt-4 inset-x-0 rounded-3xl shadow-lg z-50 bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-700 backdrop-blur-md bg-opacity-95 dark:bg-opacity-95"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
